...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white px-4 md:px-8 py-6 font-sans">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-zinc-800 rounded-2xl p-4 shadow text-center">
          <p className="text-green-400 font-bold text-lg">Vigentes</p>
          <p className="text-2xl font-semibold">{resumen.vigente}</p>
        </div>
        <div className="bg-zinc-800 rounded-2xl p-4 shadow text-center">
          <p className="text-yellow-400 font-bold text-lg">Por vencer</p>
          <p className="text-2xl font-semibold">{resumen.por_vencer}</p>
        </div>
        <div className="bg-zinc-800 rounded-2xl p-4 shadow text-center">
          <p className="text-red-400 font-bold text-lg">Vencidos</p>
          <p className="text-2xl font-semibold">{resumen.vencido}</p>
        </div>
      </section>

      <div className="bg-zinc-900 rounded-2xl p-4 shadow mb-8">
